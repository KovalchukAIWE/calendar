...
export default function AboutUs () {
    ...
    <p className={styles.text_description}>So how did the classical Latin become so incoherent? 
        ...
        before Letraset made it popular as a dummy text in the 1960s, 
        ...
        text has been used for centuries. And anyways, as Cecil Adams reasoned, 
        “[Do you really] think graphic arts supply houses were hiring classics
         scholars in the 1960s?” Perhaps. But it seems reasonable to imagine 
         that there was a version in use far before the age of Letraset.
          ...
          survived not only four centuries of letter-by-letter resetting but even 
          the leap into electronic typesetting, essentially unchanged except for 
          an occasional 'ing' or 'y' thrown in. It's ironic that when the 
